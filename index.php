                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <span>Software as your needs</span>
                                <h2>Vanguard Systems</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="hero__item set-bg" data-setbg="img/hero/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <span>Minecraft config files and more</span>
                                <h2>Vanguard Systems</h2>
                            </div>
                        </div>
                    </div>
            ...
            <div class="hero__item set-bg" data-setbg="img/hero/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <span>Everything that you think</span>
                                <h2>Vanguard Systems</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-sm-6">
                        <div class="footer__option__item">
                            <h5>About us</h5>
                            <p>Formed in 2024, Vanguard Systems is a personal project bring it up ideas to work easily.</p>
                        </div>
                    </div>
                </div>
            </div>
